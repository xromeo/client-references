...
* The original package name 'com.rivera.client-references' is invalid and this project uses 'com.rivera.clientreferences' instead.
...
```
$ docker run --rm -p 8080:8080 client-references:0.0.1-SNAPSHOT
```
